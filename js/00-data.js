...
const DB = {
        ...
        "tsh_sturdy": { n: "強韌棉質內衣", type: "arm", slot: "tshirt", ac: 1, mhp: 30, con: 1, req: "all", safe: 4, p: 18000, gachaWeight: 0, d: "以厚實棉布反覆縫製的入門戰鬥內衣。<br>HP +30、體質 +1。<br><span class='text-amber-300'>取得方式：哈巴特製作。</span>" },
        "tsh_hunter": { n: "迅捷獵手內衣", type: "arm", slot: "tshirt", ac: 1, dex: 1, rangedHit: 2, req: "all", safe: 4, p: 32000, gachaWeight: 0, d: "減少動作阻力的輕量內衣，適合弓手與敏捷型冒險者。<br>敏捷 +1、遠距離命中 +2。<br><span class='text-amber-300'>取得方式：哈巴特製作。</span>" },
        "tsh_berserker": { n: "狂戰士內衣", type: "arm", slot: "tshirt", ac: 1, str: 1, meleeDmg: 2, req: "all", safe: 4, p: 32000, gachaWeight: 0, d: "刻有戰鬥符文的貼身內衣，能將力量集中於每次揮擊。<br>力量 +1、近距離傷害 +2。<br><span class='text-amber-300'>取得方式：哈巴特製作。</span>" },
        "tsh_arcane": { n: "秘法絲織內衣", type: "arm", slot: "tshirt", ac: 1, int: 1, mmp: 40, mdmg: 2, req: "all", safe: 4, p: 36000, gachaWeight: 0, d: "以魔力絲線織成，能穩定施法時流動的魔力。<br>智力 +1、MP +40、魔法傷害 +2。<br><span class='text-amber-300'>取得方式：哈巴特製作。</span>" },
        "tsh_prayer": { n: "聖潔祈禱內衣", type: "arm", slot: "tshirt", ac: 2, wis: 1, mr: 8, mpR: 2, req: "all", safe: 4, p: 40000, gachaWeight: 0, d: "受神官祝禱的純白內衣，能抵禦魔力侵蝕。<br>精神 +1、MR +8、MP恢復量 +2。<br><span class='text-amber-300'>取得方式：哈巴特製作。</span>" },
        "tsh_elemental": { n: "四元素守護內衣", type: "arm", slot: "tshirt", ac: 2, resFire: 10, resWater: 10, resWind: 10, resEarth: 10, req: "all", safe: 4, p: 60000, gachaWeight: 0, d: "融合火、水、風、地四種氣息的防護內衣。<br>火、水、風、地屬性抗性各 +10。<br><span class='text-amber-300'>取得方式：哈巴特製作。</span>" },
        "tsh_dragonblood": { n: "龍血戰紋內衣", type: "arm", slot: "tshirt", ac: 3, mhp: 100, dr: 1, meleeDmg: 2, rangedDmg: 2, req: "all", safe: 4, p: 90000, gachaWeight: 0, d: "以龍血繪製戰紋的高階內衣，兼具生存與攻擊能力。<br>HP +100、傷害減免 +1、近／遠距離傷害 +2。<br><span class='text-amber-300'>取得方式：哈巴特製作。</span>" },
        "tsh_heroic": { n: "英雄榮耀內衣", type: "arm", slot: "tshirt", ac: 4, str: 1, dex: 1, con: 1, int: 1, wis: 1, cha: 1, mhp: 150, mmp: 50, meleeDmg: 3, rangedDmg: 3, mdmg: 3, mr: 10, req: "all", safe: 4, p: 150000, gachaWeight: 0, d: "只有完成多重鍛造考驗的英雄才能穿戴。<br>全能力 +1、HP +150、MP +50、近／遠距離／魔法傷害 +3、MR +10。<br><span class='text-amber-300'>取得方式：哈巴特製作。</span>" },
        ...
        "sherine_remain_claw":  { n:"席琳遺骸・武器", type:"acc", slot:"sherine_claw",  img:"assets/icons/sherine/sherine_remain_claw.png?v=20260716b", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"武器遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_eye":   { n:"席琳遺骸・頭盔", type:"acc", slot:"sherine_eye",   img:"assets/icons/sherine/sherine_remain_eye.png?v=20260716b", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"頭盔遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_blood": { n:"席琳遺骸・盔甲", type:"acc", slot:"sherine_blood", img:"assets/icons/sherine/sherine_remain_blood.png?v=20260716b", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"盔甲遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_flesh": { n:"席琳遺骸・T恤", type:"acc", slot:"sherine_flesh", img:"assets/icons/sherine/sherine_remain_flesh.png?v=20260716b", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"T恤遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_heart": { n:"席琳遺骸・手套", type:"acc", slot:"sherine_heart", img:"assets/icons/sherine/sherine_remain_heart.png?v=20260716b", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"手套遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_bone":  { n:"席琳遺骸・長靴", type:"acc", slot:"sherine_bone",  img:"assets/icons/sherine/sherine_remain_bone.png?v=20260716b", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"長靴遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_fang":  { n:"席琳遺骸・斗篷", type:"acc", slot:"sherine_fang",  img:"assets/icons/sherine/sherine_remain_fang.png?v=20260716b", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"斗篷遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_scale": { n:"席琳遺骸・副手", type:"acc", slot:"sherine_scale", img:"assets/icons/sherine/sherine_remain_scale.png?v=20260716b", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"副手遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_horn":  { n:"席琳遺骸・耳環 I", type:"acc", slot:"sherine_horn",  img:"assets/icons/sherine/sherine_remain_horn.png?v=20260716b", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"第一耳環遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_wing":  { n:"席琳遺骸・耳環 II", type:"acc", slot:"sherine_wing",  img:"assets/icons/sherine/sherine_remain_wing.png?v=20260716b", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"第二耳環遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_tail":  { n:"席琳遺骸・戒指 I", type:"acc", slot:"sherine_tail",  img:"assets/icons/sherine/sherine_remain_tail.png?v=20260716b", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"第一戒指遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_soul":  { n:"席琳遺骸・戒指 II", type:"acc", slot:"sherine_soul",  img:"assets/icons/sherine/sherine_remain_soul.png?v=20260716b", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"第二戒指遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_hide":  { n:"席琳遺骸・戒指 III", type:"acc", slot:"sherine_hide",  img:"assets/icons/sherine/sherine_remain_hide.png?v=20260716b", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"第三戒指遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_marrow":{ n:"席琳遺骸・戒指 IV", type:"acc", slot:"sherine_marrow",img:"assets/icons/sherine/sherine_remain_marrow.png?v=20260716b", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"第四戒指遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_vein":  { n:"席琳遺骸・腰帶", type:"acc", slot:"sherine_vein",  img:"assets/icons/sherine/sherine_remain_vein.png?v=20260716b", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"腰帶遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_shell": { n:"席琳遺骸・項鍊", type:"acc", slot:"sherine_shell", img:"assets/icons/sherine/sherine_remain_shell.png?v=20260716b", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"項鍊遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_shin":  { n:"席琳遺骸・脛甲", type:"acc", slot:"sherine_shin", img:"assets/icons/sherine/sherine_remain_shin.png?v=20260716b", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"脛甲遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        ...
        "potion_ancient_heal": { n: "古代體力恢復劑", type: "pot", req: "all", p: 200, c: "text-amber-200", img: "assets/icons/items/古代體力恢復劑.png", d: "隨機恢復 30~50 HP；使用後無藥水延遲。", val: 40, valMin: 30, valMax: 50, potionDelay: 0, gachaWeight: 0 },
