...
const DB = {
        ...
        "sherine_remain_claw":  { n:"席琳遺骸・武器", type:"acc", slot:"sherine_claw",  img:"assets/icons/sherine/sherine_remain_claw.png", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"武器遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_eye":   { n:"席琳遺骸・頭盔", type:"acc", slot:"sherine_eye",   img:"assets/icons/sherine/sherine_remain_eye.png", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"頭盔遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_blood": { n:"席琳遺骸・盔甲", type:"acc", slot:"sherine_blood", img:"assets/icons/sherine/sherine_remain_blood.png", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"盔甲遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_flesh": { n:"席琳遺骸・T恤", type:"acc", slot:"sherine_flesh", img:"assets/icons/sherine/sherine_remain_flesh.png", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"T恤遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_heart": { n:"席琳遺骸・手套", type:"acc", slot:"sherine_heart", img:"assets/icons/sherine/sherine_remain_heart.png", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"手套遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_bone":  { n:"席琳遺骸・長靴", type:"acc", slot:"sherine_bone",  img:"assets/icons/sherine/sherine_remain_bone.png", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"長靴遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_fang":  { n:"席琳遺骸・斗篷", type:"acc", slot:"sherine_fang",  img:"assets/icons/sherine/sherine_remain_fang.png", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"斗篷遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_scale": { n:"席琳遺骸・副手", type:"acc", slot:"sherine_scale", img:"assets/icons/sherine/sherine_remain_scale.png", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"副手遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_horn":  { n:"席琳遺骸・耳環 I", type:"acc", slot:"sherine_horn",  img:"assets/icons/sherine/sherine_remain_horn.png", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"第一耳環遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_wing":  { n:"席琳遺骸・耳環 II", type:"acc", slot:"sherine_wing",  img:"assets/icons/sherine/sherine_remain_wing.png", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"第二耳環遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_tail":  { n:"席琳遺骸・戒指 I", type:"acc", slot:"sherine_tail",  img:"assets/icons/sherine/sherine_remain_tail.png", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"第一戒指遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_soul":  { n:"席琳遺骸・戒指 II", type:"acc", slot:"sherine_soul",  img:"assets/icons/sherine/sherine_remain_soul.png", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"第二戒指遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_hide":  { n:"席琳遺骸・戒指 III", type:"acc", slot:"sherine_hide",  img:"assets/icons/sherine/sherine_remain_hide.png", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"第三戒指遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_marrow":{ n:"席琳遺骸・戒指 IV", type:"acc", slot:"sherine_marrow",img:"assets/icons/sherine/sherine_remain_marrow.png", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"第四戒指遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_vein":  { n:"席琳遺骸・腰帶", type:"acc", slot:"sherine_vein",  img:"assets/icons/sherine/sherine_remain_vein.png", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"腰帶遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_shell": { n:"席琳遺骸・項鍊", type:"acc", slot:"sherine_shell", img:"assets/icons/sherine/sherine_remain_shell.png", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"項鍊遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
        "sherine_remain_shin":  { n:"席琳遺骸・脛甲", type:"acc", slot:"sherine_shin", img:"assets/icons/sherine/sherine_remain_shin.png", req:"all", p:0, safe:0, noEnhance:true, noSell:true, sherineRemain:true, gachaWeight:0, d:"脛甲遺骸格。不占負重、不能強化且沒有基礎能力；只承載一種席琳套裝詞綴。" },
